...
│	│      └─resources
│	│  
│	└─03-spring-cloud-payment-3000 # 支付模块
│		├─src
│		  ├─main
│			├─java
...
* 父级工程只提供 `pom.xml` 依赖信息，具体信息如下：
  ...
  <img src="https://cdn.jsdelivr.net/gh/wicksonZhang/static-source-cdn/images/202312280915962.png" alt="image-20231228091551915" style="zoom:100%;float:left" />
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <modules>
        ...
        <module>03-spring-cloud-payment-3000</module>
    </modules>
...
<img src="https://cdn.jsdelivr.net/gh/wicksonZhang/static-source-cdn/images/202312281017748.png" alt="image-20231228101745717" style="zoom:100%;float:left" />
